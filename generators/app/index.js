...
writing: {
  ...
  this.fs.copy(
    ...
    Angular : function ()
    {
      ...
      this.fs.copy(
        this.templatePath('shared.ts'),
        this.destinationPath('app/shared/shared.ts ')
      ),
      this.fs.copy(
        this.templatePath('shared.service.ts'),
        this.destinationPath('app/shared/shared.service.ts ')
      ),
      this.fs.copy(
        this.templatePath('shared.service.ts'),
        this.destinationPath('app/shared/shared.component ')
      ),
      this.fs.copy(
        this.templatePath('config.ts'),
        this.destinationPath('app/shared/config.ts ')
      )
    },
    bower: function () {
      var bower = {
